...
import models
from metrics import *
from datasets.mp_liver_dataset import MultiPhaseLiverDataset, collate_fn_eval_train

from models import Merge_uniformer, Merge_uniformer_Base
...
def validate(args):
    ...
    dataset = MultiPhaseLiverDataset(args, is_training=False, is_cls2=False)
    ...
    predictions, label, eval_img_path, err_label = val_onemodel(model, dataset, loader, args)
    
    return process_prediction(predictions)

def val_onemodel(model, dataset, loader, args):
